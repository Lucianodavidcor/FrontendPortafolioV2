  ...
  return (
    <>
      ...
      <main className="flex-1">
          ...
          <div className="relative z-10 max-w-7xl mx-auto text-center md:text-left grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <h1 className="text-6xl md:text-8xl font-black leading-[0.9] tracking-tighter uppercase">
                CREANDO <br />
                <span className="text-primary italic">POESÍA</span><br />
                DIGITAL.
              </h1>
              ...
              <div className="flex flex-wrap gap-4 pt-4 justify-center md:justify-start">
                <a href="#proyectos" className="bg-primary text-white px-8 py-4 rounded-xl font-bold flex items-center gap-2 group">
                  Ver Proyectos
                  <ArrowRight className="w-5 h-5 transition-transform group-hover:translate-x-1" />
                </a>
                <a href="/cv.pdf" target="_blank" className="flex items-center gap-2 bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 px-8 py-4 rounded-xl font-bold hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors shadow-lg">
            ...
            <div className="relative flex justify-center lg:justify-end">
              <div className="relative w-72 h-96 md:w-96 md:h-[500px] rounded-3xl overflow-hidden shadow-2xl rotate-3 hover:rotate-0 transition-transform duration-500">
                {/* Nota: Usamos una imagen directa por ahora como acordamos */}
                <img 
              ...
              <div className="absolute -bottom-6 -left-6 md:-left-12 glass-card p-6 rounded-2xl shadow-xl max-w-[200px]">
                <p className="text-xs font-bold text-primary mb-2 uppercase tracking-widest">Impacto Global</p>
                <p className="text-sm font-medium">Ayudando a marcas desde NYC hasta Tokio a destacar.</p>
              </div>
            </div>
        ...
        {/* PRÓXIMAS SECCIONES (Las haremos en el siguiente paso) */}

...
// Forzamos que la página se revalide cada cierto tiempo si quieres ISR (Incremental Static Regeneration)
export const revalidate = 60; // 60 segundos

export default async function Home() {
  // Ejecutamos todas las llamadas a la API en paralelo para máxima velocidad
          ...
          <div className="relative z-10 max-w-7xl mx-auto text-center md:text-left grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-wrap gap-4 pt-4 justify-center md:justify-start">
                <a href="#proyectos" className="bg-primary text-white px-8 py-4 rounded-xl font-bold flex items-center gap-2 group shadow-lg shadow-primary/20 hover:scale-105 transition-transform">
                  Ver Proyectos
